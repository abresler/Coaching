...
(function() { 
	...
	var onShotchartClick = function (e) {
		...
		window.open(href,'popUpWindow','height=750,width=780,left=10,top=10,resizable=no,scrollbars=no,toolbar=no,menubar=no,location=no,directories=no,status=no');	
	};
